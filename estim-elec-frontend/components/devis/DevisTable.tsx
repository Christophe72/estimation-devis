      ...
      <table className="min-w-full border border-zinc-200 bg-white">
        <thead>
          <tr className="bg-zinc-100 text-left">
            <th className="border-b border-zinc-200 px-3 py-2">N° Devis</th>
        ...
        <tbody>
          {devis.map((d) => (
            <tr key={d.id} className="hover:bg-zinc-50">
              <td className="border-b border-zinc-200 px-3 py-2 font-mono text-sm">{d.numero}</td>
              <td className="border-b border-zinc-200 px-3 py-2">{d.chantierNom}</td>
              <td className="border-b border-zinc-200 px-3 py-2">{d.customerNom}</td>
